/* Compilado com as flags do gcc/clang `-fsanitize=address -Wall -Wextra -pedantic -Wwrite-strings`.
 * para ter mais certeza que o codigo esta sendo escrito sem depender de
 * mas praticas (-Wall, -Wextra, -pedantic, -Wwrite-strings) ou memory leaks (-fsanitize=address). */
...
void testeListar()
{
    ...
    printf("%d\n", getDadosEstruturaAuxiliar(1, vet, tamVet) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d\n", getDadosEstruturaAuxiliar(11, vet, tamVet) == POSICAO_INVALIDA);
    printf("%d\n", getDadosEstruturaAuxiliar(2, vet, tamVet) == SUCESSO);

    printf("%d\n", vet[0] == 7);
    printf("%d\n", vet[1] == -9);

    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(1, vet, tamVet) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(11, vet, tamVet) == POSICAO_INVALIDA);
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(2, vet, tamVet) == SUCESSO);
    ...
    printf("%d\n", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO);
    printf("%d\n", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO);
    // removendo para o primeiro e segundo teste da funcao abaixo funcionar
    printf("%d\n", excluirNumeroDoFinaldaEstrutura(9) == SUCESSO);
}
...
void testeRetornarTodosNumeros()
{
    ...
    int const tamVet1 = 2;
    int vet1[2];
    printf("%d\n", getDadosDeTodasEstruturasAuxiliares(vet1, tamVet1) == TODAS_ESTRUTURAS_AUXILIARES_VAZIAS);

    printf("%d\n", getDadosOrdenadosDeTodasEstruturasAuxiliares(vet1, tamVet1) == TODAS_ESTRUTURAS_AUXILIARES_VAZIAS);
...
*/
    ...
    printf("%d\n", getDadosDeTodasEstruturasAuxiliares(vet, tamVet) == SUCESSO);
    ...
    printf("%d\n", getDadosOrdenadosDeTodasEstruturasAuxiliares(vet2, tamVet2) == SUCESSO);
...
void testeListaEncadeada()
{
    ...
    getDadosListaEncadeadaComCabecote(inicio, vet, tamVet);
